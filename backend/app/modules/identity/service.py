...
class IdentityService:
    ...
    async def login(self, email: str, password: str, tenant_slug: str | None) -> TokenPair:
    ...
    async def switch_tenant(self, claims: TokenClaims, tenant_id: uuid.UUID) -> TokenPair:
